...
#print("Mean squared error: %.2f" % mean_squared_error(feature_train, target_train))
#print('Variance score: %.2f' % r2_score(feature_train, target_train))
...
print('New coefficients: ', reg.coef_, reg.intercept_)
